...
void viconCallBack(const geometry_msgs::PoseStamped::ConstPtr &vicon_odom )
{
    ...
    vicon_odom_.header.frame_id = "/world";
    ...
    path_vicon.header.frame_id = "/world";
        ...
        for (iterCount = 0; iterCount < 40; iterCount ++) // 25
        {
          for (int i = 0; i < cornerPointsSharpNum; i++) 
          {
            ...
            if (1)//(iterCount % 5 == 0) 
            {
              ...
              //cout<<minPointInd2<<endl;
                ...
                float pointSqDis, minPointSqDis2 = 10;//25 // ### Indoor 10 is perfect ... 
                for (int j = closestPointInd + 1; j < cornerPointsSharpNum; j++) 
                {
                      if (int(laserCloudCornerLast->points[j].intensity) > closestPointScan + 1.5) //Original: 2.5 ## Indoor 1.5 is perfect ...
                           break;//break
          ...
          for (int i = 0; i < surfPointsFlatNum; i++) 
          {
            ...
            if (1)//(iterCount % 5 == 0) {//iterCount % 5 == 0
            {
              ...
              if (pointSearchSqDis[0] < 10) //#####: Indoor 10 is perfect ..
              {
                  closestPointInd = pointSearchInd[0];
                  int closestPointScan = int(laserCloudSurfLast->points[closestPointInd].intensity);
                  float pointSqDis, minPointSqDis2 = 10, minPointSqDis3 = 10;
          ...
          if (iterCount == 0) {
            ...
            isDegenerate = false;
            float eignThre[6] = {10, 10, 10, 5, 5, 5};//{20, 20, 20, 10, 10, 10};
            for (int i = 5; i >= 0; i--) {
          ...
          if (deltaR < 0.05 && deltaT < 0.1) //0.1 0.2 for debug OK
            break;
